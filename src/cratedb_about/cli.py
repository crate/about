...
@click.option(
    "--format", "-f", "format_", type=click.Choice(["llms-txt", "markdown", "yaml", "json"]), default="markdown", help="Output format"
)
@click.option("--optional", "-o", is_flag=True, help="When producing llms-txt output, control whether to include the optional section")
def outline(url: str, format_: t.Literal["llms-txt", "markdown", "yaml", "json"] = "markdown", optional: bool = False) -> None:
    """

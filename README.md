...
```
Alternatively to the `--url` option, you can use the `OUTLINE_URL` environment
variable. You will need to minimally install `cratedb-about[manyio]` to use
the custom outline file feature. You can address resources on many filesystems
through the excellent "fsspec" package.
